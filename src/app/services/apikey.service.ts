...
export class ApikeyService {
  // private base = 'https://10.0.0.2:5000/api/apikeys';
  ...
  verify(id: string ){
    ...
    // return this.http.get(`https://10.0.0.2:5000/public/verify/${id}`,{headers: header});
  ...
  getHello(token:string){
    ...
    // return this.http.get('https://10.0.0.2:5000/protected/hello' ,{headers: header});
  }
}
